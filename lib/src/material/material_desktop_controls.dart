...
class _MaterialDesktopControlsState extends State<MaterialDesktopControls>
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Row(
                  children: <Widget>[
                    widget.playPrevious==null?SizedBox():
                    _buildPrevious(controller, widget.playPrevious!)!,
                    _buildPlayPause(controller),
                    widget.playNext==null?SizedBox():
                    _buildNext(controller, widget.playNext!)!,
  ...
  Widget? _buildNext(
      VideoPlayerController controller, Widget? playNext) {
    // return GestureDetector(
    //   onTap: () {
    //     print("nextttt");
    //     playNext=playNext!+1;
  ...
  Widget? _buildPrevious(
      VideoPlayerController controller, Widget? playPrevious) {
    return playPrevious;
    // return GestureDetector(
    //   onTap: () {
    //     print("okkk");
    //     playPrevious=playPrevious!-1;
    //     print(playPrevious);
    //     notifier.notifyListeners();
    //   },
    //   child: Container(
