...
class Chewie extends StatefulWidget {
  ...
  late final Widget? playNext;
  late final Widget? playPrevious;
  Chewie({
    Key? key,
...
class ChewieState extends State<Chewie> {
  ...
  void initState() {
    ...
    if(widget.playNext==null){
      widget.playNext=SizedBox();
    }
    if(widget.playPrevious==null){
      widget.playPrevious=SizedBox();
    }
  ...
  Widget build(BuildContext context) {
    return ChewieControllerProvider(
      ...
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => PlayerWithControls(platform: widget.platform!,playNext: widget.playNext,playPrevious: widget.playPrevious,),
      ),
    );
  }
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    final controllerProvider = ChewieControllerProvider(
      ...
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => PlayerWithControls(platform: widget.platform),
      ),
    );
